#ifndef CCFG_IO_DB_MYSQLCONFIGDAO_H_INCLUDED
#define CCFG_IO_DB_MYSQLCONFIGDAO_H_INCLUDED
 ...
 * @author fchateau
 */
class MySqlConfigDao : public ConfigDao
{
public:
	MySqlConfigDao();
	virtual ~MySqlConfigDao();
	// @{ Connection
	void connect(const std::string& connectionString);
	void connect(const std::string& host, const std::string& port, const std::string& uid, const std::string& pwd, const std::string& db);
	// @}
...
private:
	MySqlConfigDao(const MySqlConfigDao& rvalue);
	MySqlConfigDao& operator=(const MySqlConfigDao& rvalue);
};
...
#endif // CCFG_IO_DB_MYSQLCONFIGDAO_H_INCLUDED
