...
const int CSHK[4] = {14, 15, 16, 17};           // This is chip select pin 
 
/* enable or disable debug */
#define DEBUG_ENABLED 0

/* delay for reading and writing registers  */
#define READ_WRITE_DELAY 3 //now in us
...
public:
  ...
  /*
  =======================================
  This is a custom function which takes
  @ care of all the initialization and 
  @ setup of the ADC, such as setting the
  @ reference voltage and sampling rate.
  =======================================
  */
  bool init_ADC(uint8_t ADC_ID);
